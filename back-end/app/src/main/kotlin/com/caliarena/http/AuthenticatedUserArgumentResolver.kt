    ...
    override fun resolveArgument(
        ...
        val request =
            webRequest.getNativeRequest(HttpServletRequest::class.java)
                ?: throw IllegalStateException("No HttpServletRequest found in webRequest")

        return getUserFrom(request) ?: throw IllegalStateException("No HttpServletRequest found in webRequest")
    }
