...
INSERT INTO matches (bracket_id, routine_id, athlete_red_id, athlete_blue_id, winner_athlete_id, status,
                     started_at, finished_at, created_at)
VALUES
    -- QUALIFIERS (24 athletes, 12 finished matches)
    (1, 1, 1, 2, 1, 'FINISHED', 1787329000000, 1787329110000, 1787328276),
    (1, 1, 3, 4, 3, 'FINISHED', 1787329300000, 1787329420000, 1787328276),
    (1, 1, 5, 6, 5, 'FINISHED', 1787329600000, 1787329731000, 1787328276),
    (1, 1, 7, 8, 8, 'FINISHED', 1787329900000, 1787330015000, 1787328276),
    (1, 1, 9, 10, 10, 'FINISHED', 1787330200000, 1787330322000, 1787328276),
    (1, 1, 11, 12, 11, 'FINISHED', 1787330500000, 1787330640000, 1787328276),
    (1, 1, 13, 14, 14, 'FINISHED', 1787330800000, 1787330918000, 1787328276),
    (1, 1, 15, 16, 16, 'FINISHED', 1787331100000, 1787331226000, 1787328276),
    (1, 1, 17, 18, 17, 'FINISHED', 1787331400000, 1787331549000, 1787328276),
    (1, 1, 19, 20, 20, 'FINISHED', 1787331700000, 1787331833000, 1787328276),
    (1, 1, 21, 22, 22, 'FINISHED', 1787332000000, 1787332116000, 1787328276),
    (1, 1, 23, 24, 24, 'FINISHED', 1787332300000, 1787332444000, 1787328276),
    -- QUARTERFINALS
    (2, 2, 1, 2, 1, 'FINISHED', 1787333000000, 1787333220000, 1787328276),
    (2, 2, 3, 4, 3, 'FINISHED', 1787333100000, 1787333325000, 1787328276),
    (2, 2, 5, 6, 5, 'FINISHED', 1787333200000, 1787333430000, 1787328276),
    (2, 2, 7, 8, 7, 'FINISHED', 1787333300000, 1787333510000, 1787328276),
    -- SEMIFINALS
    (3, 3, 1, 3, 1, 'FINISHED', 1787334100000, 1787334330000, 1787328276),
    (3, 3, 5, 7, 5, 'FINISHED', 1787334200000, 1787334435000, 1787328276),
    -- FINAL
    (4, 4, 1, 5, 1, 'FINISHED', 1787335000000, 1787335240000, 1787328276);
